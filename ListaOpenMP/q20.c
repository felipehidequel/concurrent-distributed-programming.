/*
Baixe o arquivo omp_trap_1.c do site do livro e exclua a diretiva critical.
Compile e execute o programa com cada vez mais threads e valores cada vez
maiores de n. (a) Quantas threads e quantos trapézios são necessários antes que
o resultado esteja incorreto? (b) Como o aumento do número de trapézios
influencia nas chances do resultado ser incorreto? (c) Como o aumento do número
de threads influencia nas chances do resultado ser incorreto?
*/
