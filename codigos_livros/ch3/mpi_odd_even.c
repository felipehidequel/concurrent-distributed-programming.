...
void Odd_even_iter(int local_A[], int temp_B[], int temp_C[], int local_n,
...
void Sort(int local_A[], int local_n, int my_rank, int p, MPI_Comm comm) {
  ...
  for (phase = 0; phase < p; phase++)
    Odd_even_iter(local_A, temp_B, temp_C, local_n, phase, even_partner,
                  odd_partner, my_rank, p, comm);
