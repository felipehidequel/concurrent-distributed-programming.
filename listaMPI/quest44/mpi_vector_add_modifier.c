...
void Read_vector(double local_a[], int local_n, int n, char vec_name[],
                 int my_rank, MPI_Comm comm, MPI_Datatype vector);
...
int main(void) {
  ...
  create_datatype(&local_n, &vector, comm);
  ...
  Read_vector(local_x, local_n, n, "x", my_rank, comm, vector);
  Print_vector(local_x, local_n, n, "x is", my_rank, comm, vector);
  Read_vector(local_y, local_n, n, "y", my_rank, comm, vector);
  Print_vector(local_y, local_n, n, "y is", my_rank, comm, vector);

  Parallel_vector_sum(local_x, local_y, local_z, local_n);
  Print_vector(local_z, local_n, n, "The sum is", my_rank, comm, vector);
 ...
 */
void Read_n(int *n_p /* out */, int *local_n_p /* out */, int my_rank /* in  */,
 ...
 */
void Parallel_vector_sum(double local_x[] /* in  */, double local_y[] /* in  */,
                         double local_z[] /* out */, int local_n /* in  */) {
  int local_i;
