...
int main(void) {
  int my_rank, comm_sz, n, local_n, rest;
 ...
 */
void Build_mpi_type(double *a_p /* in  */, double *b_p /* in  */,
                    int *n_p /* in  */, MPI_Datatype *input_mpi_t_p /* out */) {
 ...
 *               n_p:  pointer to number of trapezoids
 */
void Get_input(int my_rank /* in  */, int comm_sz /* in  */,
               double *a_p /* out */, double *b_p /* out */,
               int *n_p /* out */) {
 ...
 * Input args:  x
 */
double f(double x /* in */) { return x * x; } /* f */
